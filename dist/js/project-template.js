...
templates['project'] = template({"1":function(container,depth0,helpers,partials,data) {
  ...
  return "    <h1>Weather Update</h1>\r\n    <div>Location: "
    ...
    + "</div>\r\n    <div>Date: "
    + alias2(((helper = (helper = helpers.currentDate || (depth0 != null ? depth0.currentDate : depth0)) != null ? helper : alias4),(typeof helper === alias5 ? helper.call(alias3,{"name":"currentDate","hash":{},"data":data}) : helper)))
    + "</div>\r\n    <div>Conditions: "
    ...
    + " "
    + alias2(((helper = (helper = helpers.temperature || (depth0 != null ? depth0.temperature : depth0)) != null ? helper : alias4),(typeof helper === alias5 ? helper.call(alias3,{"name":"temperature","hash":{},"data":data}) : helper)))
    + "</div>\r\n    <div>Sunrise: "
